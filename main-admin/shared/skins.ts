...
function skinAdapter(): string {
  ...
  const NAV = '.skin-side a[data-slot="link"]'
  return [
    item ? `${NAV} { ${item} }` : '',
    ...
    btn ? `.skin-main [data-gen="toolbar"] button:not(:empty), .skin-main [data-gen="search"] button { ${btn} }` : '',
    btnPrimary ? `.skin-main [data-gen="toolbar"] button.bg-primary, .skin-main [data-gen="search"] button.bg-primary { ${btnPrimary} }` : '',
    btnGhost ? `.skin-main [data-gen="toolbar"] button.ring-inset, .skin-main [data-gen="search"] button.ring-inset { ${btnGhost} }` : '',
