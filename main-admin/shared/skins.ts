...
/**
 * 默认暗色表面基准色（对应 Tailwind neutral-900 / Nuxt UI 默认暗底）。
 * 用于设计系统 dark 模式与 WCAG AA 对比度数学推导。
 */
export const DEFAULT_DARK_BG = '#171717'
